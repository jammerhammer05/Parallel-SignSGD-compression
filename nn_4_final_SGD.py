...
# def cost_function(theta1, theta2, input_layer_size, hidden_layer_1_size, output_layer_size, inputs, labels, regular=0):
    ...
    return cost, (theta1_grad, theta2_grad,theta3_grad)
...
def gradient_descent(inputs, labels, learningrate=0.8, iteration=50):
    ...
    for i in range(iteration):
        ...
        if Distributed is True:
            ...
            # by cost function.
            comm.Barrier()
            cost, (theta1_grad, theta2_grad,theta3_grad) = cost_function(theta1, theta2,theta3,
...
if __name__ == '__main__':
    ...
    model = train(xtrain, ytrain, learningrate=0.8, iteration=200)
...
plt.plot(iterationsArray, costArray, label = 'Cost vs iterations')
plt.ylabel('Cost', fontsize = 14)
plt.xlabel('iterations', fontsize = 14)
plt.title('Cost Vs Iterations with normal SGD in Neural Network with 4 cores', fontsize = 18, y = 1.03)
plt.show()